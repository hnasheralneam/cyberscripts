...
First, install vagrant and run `vagrant plugin install vagrant-libvirt` to install linux virtualization support  
...
Current setup includes Ubuntu, Fedora, Alpine, and Rocky
